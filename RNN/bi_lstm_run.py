...
from RNN.bi_lstm_model import BiLSTMConfig, TextBiLSTM
...
log_dir = 'log/bi_lstm.log'

save_dir = 'model/bi_lstm'
...
if __name__ == '__main__':
    ...
    mylog = open(log_dir, 'a')
    print('Configuring Bi-LSTM model...')
    mylog.write('Configuring Bi-LSTM model...\n')

    config = BiLSTMConfig()
    print('lstm_nums:' + str(config.hidden_dim) + '\n')
    mylog.write('lstm_nums:' + str(config.hidden_dim) + '\n')
    mylog.flush()
    mylog.close()
