...
def train():
    ...
    require_improvement = 200  # 如果超过100轮未提升，提前结束训练
...
if __name__ == '__main__':
    ...
    config = TCNNConfig()
    print('kernel_size1:' + str(config.kernel_size1) + '\t num_filters1:' + str(config.num_filters1) + '\n')
    mylog.write('kernel_size1:' + str(config.kernel_size1) + '\t num_filters1:' + str(config.num_filters1) + '\n')
    print('kernel_size2:' + str(config.kernel_size2) + '\t num_filters2:' + str(config.num_filters2) + '\n')
    mylog.write('kernel_size2:' + str(config.kernel_size2) + '\t num_filters2:' + str(config.num_filters2) + '\n')
    mylog.flush()
    mylog.close()
