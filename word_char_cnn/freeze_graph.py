...
'''
python freeze_graph.py --input_graph=./graph/nn_model.pbtxt --input_checkpoint=./model/cnn/best_validation --output_graph=./model/nn_model_frozen.pb --output_node_names="score/Softmax_1"
'''