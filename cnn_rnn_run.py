...
from cnn_rnn_model import TCNN_RNNConfig, TextCNN_RNN
...
log_dir = 'log/cnn_rnn.log'

save_dir = 'model/cnn_rnn'
...
def train():
    ...
    tensorboard_dir = 'tensorboard/cnn_rnn'
    ...
    require_improvement = 100  # 如果超过100轮未提升，提前结束训练
    ...
    for epoch in range(config.num_epochs):
        ...
        batch_train = batch_iter(x_train, y_train, config.bitch_size)
...
if __name__ == '__main__':
    ...
    mylog = open(log_dir, 'a')
    print('Configuring CNN_RNN model...')
    mylog.write('Configuring CNN_RNN model...\n')
    mylog.flush()
    mylog.close()

    config = TCNN_RNNConfig()
